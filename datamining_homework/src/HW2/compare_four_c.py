...
def main():
    ...
    #     if test_comp[i][0] == 1 and test_comp[i][1] == 1:
    #         TP += 1
    #     elif test_comp[i][0] == 1 and test_comp[i][1] == 2:
    #         FN += 1
    #     elif test_comp[i][0] == 2 and test_comp[i][1] == 1:
    #         FP += 1
    #     elif test_comp[i][0] == 2 and test_comp[i][1] == 2:
    #         TN += 1
